...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2025 at 02:28 PM
...
INSERT INTO `dispatch_log` (`id`, `item_id`, `quantity`, `requested_by`, `approved_by`, `date_dispatched`) VALUES
(1, 1, 1, 3, 2, '2025-10-28'),
(2, 2, 1, 3, 2, '2025-10-28');
...
INSERT INTO `items` (`id`, `name`, `quantity`, `category_id`, `store_number`, `date_added`) VALUES
(1, 'SB board', 5, 4, '6', '2025-10-28'),
(2, 'Device battery', 40, 5, '7', '2025-10-28');
...
--
-- Dumping data for table `receive_log`
--

INSERT INTO `receive_log` (`id`, `item_id`, `quantity`, `received_by`, `date_received`) VALUES
(1, 2, 1, 3, '2025-10-28'),
(2, 1, 1, 3, '2025-10-28');
...
CREATE TABLE `staff` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `role` enum('Accountant','ICT','Marketing','Technician','Director') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
